...
public interface CashManager {
	...
	public abstract Serializable addCashAction(CashOperation cashOperation,
			User user) throws AppException;

	public abstract List<CashOperation> loadCashOperations(Event event,
			User user) throws AppException;

	public abstract void deleteCashOperation(BigInteger id, User user)
			throws AppException;
