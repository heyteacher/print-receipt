...
public class HsqlUserManagerImpl implements UserManager {

	@Override
	public User autenticate(String login, String password) throws AppException {
		return HsqlModelFactory.USER;
	}
