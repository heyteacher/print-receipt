...
public class MoveUpDownCellTableEditor extends AbstractCellEditor implements
	...
	public MoveUpDownCellTableEditor(int direction) {
		button = new JButton(direction == ConfigureTableModel.MOVE_UP ? "↑": "↓");
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			tableModel.move(currentRow, direction);
